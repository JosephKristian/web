...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/mahasiswa/create', [MahasiswaController::class, 'create'])->name('admin.m.create');
    ...
    Route::post('/mahasiswa/{id}', [MahasiswaController::class, 'update'])->name('admin.mahasiswa.update');
